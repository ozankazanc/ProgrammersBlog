...
namespace ProgrammersBlog.Data.Migrations
{
    public partial class SeedingCategories : Migration
    {
        ...
        {
            //Veri eklemek ve düzenlemek için

            //migrationBuilder.Sql("INSERT INTO Categories (Name,Description) Values ('Typescript','Typescript Kategorisi)"); // şeklinde sorgu yazılabilir.
            migrationBuilder.Sql(
                 "INSERT INTO [ProgrammersBlog].dbo.Categories (Name,Description,Note,CreatedDate,CretedByName,ModifiedDate,ModifiedByName,IsActive,IsDeleted)" +
